package com.happycoding.hbm2service;
...
public class Helper {
	...
	public void generateService(String hbmPath,String templatePath, String outputPath,String templateFileName){
		...
		outputPath = outputPath+File.separator+util.getServicePakcagePath();
		String fileName = util.getServiceClassFileName();
		if(!HBMUtils.fileExists(outputPath, fileName)){
			...
			templateContent=templateContent.replaceAll("@PACKAGE@", util.getServicePackageName());
