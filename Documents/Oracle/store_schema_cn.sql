...
INSERT INTO customers (
  ...
  1, 'John', 'Brown', to_date('1-1月-1965', 'DD-MON-YYYY'), '800-555-1211'
);

INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone
) VALUES (
  2, 'Cynthia', 'Green', to_date('05-2月-1968', 'DD-MON-YYYY'), '800-555-1212'
);

INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone
) VALUES (
  3, 'Steve', 'White', to_date('16-3月-1971', 'DD-MON-YYYY'), '800-555-1213'
);
...
INSERT INTO customers (
  ...
  5, 'Doreen', 'Blue', to_date('20-5月-1970', 'DD-MON-YYYY'), NULL
);
...
INSERT INTO order_status (
  ...
  2, 'Order shipped', to_date('10-1月-2004','DD-MON-YYYY')
);
